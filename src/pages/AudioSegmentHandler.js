    ...
    if (!draggingItem) {
      ...
      if (data.type === 'audio') {
        ...
        try {
          ...
          // Create the final segment with backend data
          const finalSegment = {
            ...tempSegment,
          ...
          // Return the final segment for TimelineComponent to use
          return finalSegment;
        } catch (error) {
